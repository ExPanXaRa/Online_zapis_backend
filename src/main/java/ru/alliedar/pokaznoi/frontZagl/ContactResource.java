...
public class ContactResource {
    ...
    @GetMapping
    public ResponseEntity<Page<Contact>> getContacts(final @RequestParam(
    ...
    public byte[] getPhoto(final @PathVariable("filename") String filename)
            throws IOException {
        return Files.readAllBytes(Paths.get("pom.xml"));
    }
}
